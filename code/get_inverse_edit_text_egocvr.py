...
def process_row(row):
    ...
    pth1 = row['video_clip_id']  # 不含 .mp4
    pth2 = eval(row['target_clip_ids'])[0]  # 解析目标clip IDs列表
    edit= row['instruction']
    txt1 = row['video_clip_narration']
    txt2 = row['target_clip_narration']
...
if __name__ == "__main__":
    ...
    input_csv_file_path = '/hetu_group/dingzhixiang/pythonproject/ZSCVR/ZSCVR-V1/benchmark/egocvr/egocvr_annotations.csv'
    output_csv_file_path = '/hetu_group/dingzhixiang/pythonproject/ZSCVR/ZSCVR-V1/benchmark/egocvr/egocvr_annotations_reverse.csv'
